...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IDataResult<IList<ArticleListDto>>> GetAll()
        {
            var articles = await _unitOfWork.Articles.GetAllAsync(null, a => a.User, a => a.Category);
            if (articles != null)
                return new DataResult<IList<ArticleListDto>>(ResultStatus.Success, new List<ArticleListDto>
                {
                    new()
                    {
                        Articles = articles,
            ...
            return new DataResult<IList<ArticleListDto>>(ResultStatus.Error, "Makaleler bulunamadı", null);
        }

        public async Task<IDataResult<IList<ArticleListDto>>> GetAllByCategory(int categoryId)
        {
            ...
            return new DataResult<IList<ArticleListDto>>(ResultStatus.Error, "Böyle bir kategori bulunamadı", null);
        }

        public async Task<IDataResult<IList<ArticleListDto>>> GetAllByNonDeleted()
        {
        ...
        public async Task<IDataResult<IList<ArticleListDto>>> GetAllByNonDeletedAndActive()
        {
